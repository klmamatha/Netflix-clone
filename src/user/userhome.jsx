                        ...
                        {filteredMovies.map((movie) => (
                            ...
                            >
                                <div className="card position-relative bg-transparent hover:scale-95 ">
                                    ...
                                    <Link to={`/movie/${movie.id}`} className='pageImg'>
                                        <img
                                            src={movie.Poster}
                                    ...
                                    <div className="position-absolute top-0 end-0 m-3">
                                        <button
                                            className={`btn btn-link p-0 ${movie[movie.id] ? "text-danger" : "text-white"
                                                }`}
                                            onClick={() => toggleFavorite(movie.Title)}
                                        >
                                            <i
                                                className={`fa fa-heart fa-3x ${movie[movie.id] ? "text-danger" : ""
                                                    }`}
                                            ></i>
                                        </button>
                                    </div>
